...
##### **<font size=4>1.形成字符串的最短路径</font>**

```markdown
定一个 非空 字符串，将其编码为具有最短长度的字符串。
...
作者：力扣 (LeetCode)
链接：https://leetcode-cn.com/leetbook/read/dynamic-programming-1-plus/5rqb6r/
来源：力扣（LeetCode）
著作权归作者所有。商业转载请联系作者获得授权，非商业转载请注明出处。
